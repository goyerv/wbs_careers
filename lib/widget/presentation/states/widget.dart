...
Uri uriDevelopers = Uri.parse('https://www.github.com/goyerv');
...
PreferredSizeWidget? appBar(BuildContext context) {
  ...
  return AppBar(
    ...
    title: Text('Careers', style: Theme.of(context).textTheme.titleLarge),
        ...
        Center(
          child: Wrap(
            ...
            children: [
              ...
              OnHover(builder: (isHovered, context) => TextButton(onPressed: () => launchUrl(uriBulletin), focusNode: focusNodeThree, child: Text('Bulletin', style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: isHovered? defaultColor : Theme.of(context).textTheme.bodyLarge!.color)))),
              ...
              OnHover(builder: (isHovered, context) => TextButton(onPressed: () => launchUrl(uriDevelopers), focusNode: focusNodeFive, child: Text('Developers', style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: isHovered? defaultColor : Theme.of(context).textTheme.bodyLarge!.color)))),
